...
class TestP10Case1:
    ...
    def test_stage0(self):
        ...
        draw(self.g, str(DRAW_DIR / "test10-case1-stage0.png"))
    ...
    def test_stage1(self):
        ...
        draw(self.g, str(DRAW_DIR / "test10-case1-stage1.png"))
...
class TestP10Case2:
    """
    Test case 2: Hexagon with E hyperedge already having r=1.
    ...
    def test_no_match(self):
        ...
        draw(self.g, str(DRAW_DIR / "test10-case2-stage0.png"))
...
class TestP10Case3:
    """
    Test case 3: Two separate hexagons, both with S.r=0.
    Production should be applied twice, setting E.r=1 in both.
    """
    ...
    def setup(self):
        ...
        self.g.add_edge(HyperEdge(tuple(h1_nodes), "S", r=1))
        ...
        self.g.add_edge(HyperEdge(tuple(h2_nodes), "S", r=1))

        self.p10 = P10()

    def test_multiple_applications(self):
        """Should apply to both hexagons."""
        draw(self.g, str(DRAW_DIR / "test10-case3-stage0.png"))

        applied = self.g.apply(self.p10)

        draw(self.g, str(DRAW_DIR / "test10-case3-stage1.png"))

        assert applied == 2, "Should apply 2 times"

        s_edges = [e for e in self.g.hyperedges if e.hypertag == "S"]
        assert len(s_edges) == 2
        assert all(e.r == 1 for e in s_edges), "S hyperedges should remain r=1"

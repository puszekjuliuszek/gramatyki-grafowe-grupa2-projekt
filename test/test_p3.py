...
class TestP3Case5:
    ...
    def setup(self):
        ...
        self.g.add_edge(HyperEdge((n1, n2), "F", r=1, b=0))
        self.g.add_edge(HyperEdge((n2, n3), "E", r=1, b=0))
        self.g.add_edge(HyperEdge((n3), "E", r=1, b=0))
        self.g.add_edge(HyperEdge((n1), "E", r=1, b=1))

        self.p3 = P3()

    def test_stage0(self):
        """Test input graph."""
        draw(self.g, str(DRAW_DIR / "test3-case5-stage0.png"))
    ...
    def test_stage1(self):
        ...
        draw(self.g, str(DRAW_DIR / "test3-case5-stage1.png"))
        ...
        new_nodes = [n for n in nodes.values() if n.label not in {"n1", "n2", "n3"}]

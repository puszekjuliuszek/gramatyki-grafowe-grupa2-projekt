...
Left side: A hexagonal element consisting of 6 outer nodes:
           ...
           - 1 central 'S' hyperedge connecting all 6 nodes with r = 1
...
class P10(Production):
    ...
    def get_right_side(self, left: Graph) -> Graph:
        ...
        for edge in left.hyperedges:
            ...
            elif edge.hypertag == "S":
                g.add_edge(HyperEdge(edge.nodes, "S", r=edge.r, b=edge.b), check_nodes=False)
            else:
                g.add_edge(edge, check_nodes=False)
